...
impl AnnIndex {
    ...
    pub fn search(&self, query: &[f32], top_k: usize) -> Vec<(String, f32)> {
        ...
        // roughly top_k survivors. The base 3x budget is scaled by the
        // total/live ratio so a stale-heavy graph pulls more raw hits.
    ...
    /// True when stale graph slots are high enough to justify a full rebuild.
