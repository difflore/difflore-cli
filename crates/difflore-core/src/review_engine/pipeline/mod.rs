...
///
/// Deliberately a fixed constant: a 2026-07-05 A/B on a real +11k-line PR
/// showed scaling this pool with changeset size delivered zero extra rules
/// past the judge while correlating with the engine missing a known
/// violation it had caught before (0/3 vs 2/2 runs). Widen recall only
