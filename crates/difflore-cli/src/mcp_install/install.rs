...
#[allow(clippy::exit)] // reason: top-level CLI entry-point intentionally exits with non-zero on binary resolution failure.
...
#[allow(clippy::exit)] // reason: top-level CLI entry-point exits non-zero on binary resolution failure.
